          ...
          <View className="relative flex-1 overflow-hidden rounded-[32px] bg-[#FDFBF7] shadow-2xl">
            ...
            >
              ...
              {(step.timer_minutes || 0) > 0 && (
                <View
                  className={`mt-auto flex-row items-center justify-between rounded-2xl border-2 p-4 transition-all ${
                  ...
                  <View className="flex-row items-center gap-4">
                    <View
                      className={`h-12 w-12 items-center justify-center rounded-full ${
                        currentTimer?.isRunning ? "bg-primary" : "bg-surface-texture-dark"
                      }`}
                    >
                      <Clock
                        size={24}
                    ...
                    <View>
                      ...
                      <Text
                        className={`font-mono text-2xl font-medium ${
                          currentTimer?.isRunning ? "text-primary" : "text-foreground-heading"
                        }`}
                      >
                      ...
                      <>
                        ...
                        <Pressable
                          ...
                          className={`h-10 w-10 items-center justify-center rounded-full active:scale-90 ${
                            currentTimer.isRunning ? "bg-orange-100" : "bg-primary"
                          }`}
                        >
                          {currentTimer.isRunning ? (
