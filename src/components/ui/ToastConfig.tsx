  ...
  return (
    ...
    >
      ...
      <View className="flex-1">
        {text1 && <Text className="text-lg text-text-heading ">{text1}</Text>}
        {text2 && <Text className="text-base text-text-body leading-5 mt-1">{text2}</Text>}
      </View>
      <TouchableOpacity onPress={() => Toast.hide()} hitSlop={10} className="ml-2 p-1">
