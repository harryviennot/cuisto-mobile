        ...
        >
            <BottomSheetView style={{ paddingBottom: insets.bottom + 20 }}>
                <View className="px-6 py-4 border-b border-gray-100 flex-row justify-between items-center">
                    <Text className="text-lg font-bold text-foreground-heading" style={{ fontFamily: "PlayfairDisplay_700Bold" }}>
                        {t("cookingHistory.dateLabel")}
                    </Text>
                    <Pressable onPress={handleClose}>
                        <Text className="text-base text-foreground-tertiary font-medium">{t("common.cancel")}</Text>
                    </Pressable>
                </View>
                ...
                <View className="px-6">
                    ...
                    >
                        <Text className="text-base font-bold text-white tracking-wide">{t("common.confirm")}</Text>
                    </Pressable>
                </View>
            </BottomSheetView>
        </BottomSheetModal>
